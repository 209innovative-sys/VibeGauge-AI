...
Write-Host "=== Confusion-AI: Fix Plan Status Pill Visibility ===" -ForegroundColor Cyan
...
$backupDir = Join-Path $rootPath ("backup_frontend_confusionai_planstatus_" + $timestamp)
...
# Write new App.tsx
Write-Host "Writing updated App.tsx with visible plan status pill..." -ForegroundColor Yellow
...
Write-Host "=== Plan status pill fix complete. Restart Vite dev server. ===" -ForegroundColor Cyan
