...
export const VibeDashboard: React.FC = () => {
  ...
  const handleSubscribe = () => {
    console.log("Subscribe clicked â€“ hook up Stripe here.");
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        alert("Analyze failed â€“ check backend logs.");
      } else {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-[11px] sm:text-xs text-slate-300/80">
                Real-time conversation vibe radar Â· mock model wired to backend
              </p>
            </div>
          </div>
        ...
        <section className="mb-4 flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between text-[11px] sm:text-xs text-slate-200/90">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">
              {vibeLabel} Â· <span className="text-sky-300">{vibeScore}/100</span>
            </span>
          </div>
          <div className="flex items-center gap-2">
            <span
                  ...
                  <div className="rounded-2xl bg-slate-950/70 border border-slate-600/70 px-3 py-2.5">
                    <div className="flex items-center justify-between gap-2 text-[11px]">
                      ...
                      <span className="text-[10px] text-slate-400">
                        Experimental Â· not medical advice
                      </span>
                    </div>
                ...
                {[
                  ...
                  >
                    ...
                    <p className="text-[10px] text-slate-400 mt-0.5">
                      Experimental AI signal â€“ not a diagnosis.
                    </p>
                  </div>
                ))}
              </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="text-[10px] text-slate-400">
                  Messages stay in this browser Â· mock API only
                </span>
              </div>
